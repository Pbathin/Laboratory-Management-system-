...
public class ResultFrame extends JFrame {
	...
	public ResultFrame() {
		...
		DisplayBT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "select * from Samples where PID=?";
		...
		DisplayBT.setBounds(495, 98, 116, 40);
		contentPane.add(DisplayBT);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 182, 764, 268);
		...
		lblNewLabel.setIcon(new ImageIcon("G:\\My Drive\\mini project\\icons\\backfrm1.png"));

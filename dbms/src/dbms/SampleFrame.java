...
public class SampleFrame extends JFrame {
	...
	public SampleFrame() {
		...
		InsertBT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "insert into samples(Sid,Pid,Date,TechID,B1,B2,B3,B4,U1,U2,U3,S1,S2,S3) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
					...
					pst.setString(6,B2);
					String B3 = "";
					if(HemglbCB.isSelected())
					{
						B3+=HemglbCB.getText()+" ";
					}
					pst.setString(7,B3);
					String B4 = "";
					if(BloUrCB.isSelected())
					{
						B4+=BloUrCB.getText()+" ";
					}
					pst.setString(8,B4);
					String U1 = "";
					if(WetMndCB.isSelected())
					{
						U1+=WetMndCB.getText()+" ";
					}
					pst.setString(9,U1);
					String U2 = "";
					if(CulSenCB.isSelected())
					{
						U2+=CulSenCB.getText()+" ";
					}
					pst.setString(10,U2);
					...
					pst.setString(11,U3);
					String S1 = "";
					if(OccBldCB.isSelected())
					{
						S1+=OccBldCB.getText()+" ";
					}
					pst.setString(12,S1);
					String S2 = "";
					if(HngDrpCB.isSelected())
					{
						S2+=HngDrpCB.getText()+" ";
					}
					pst.setString(13,S2);
					String S3 = "";
					if(StCulSenCB.isSelected())
					{
						S3+=StCulSenCB.getText()+" ";
					}
					pst.setString(14,S3);
